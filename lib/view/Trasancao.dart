...
class _TransacaoState extends State<Transacao> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Image.asset(
              'assets/logo.png', // Certifique-se de ter o caminho correto para o logo
              height: 40,
            ),
            SizedBox(width: 10),
            Text('Nome do App'), // Substitua pelo nome do seu aplicativo
          ],
        ),
      ),
      body: Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      title: Text(
                          'Transação ${transacao['numero']} - ${transacao['tipo']} de ${transacao['equipamento']}'),
                      subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
  ...
  void _mostrarDetalhesTransacao(
      BuildContext context, Map<String, String> transacao) {
    showDialog(
      context: context,
